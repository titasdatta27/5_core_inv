...
class HealthController extends Controller
{
     ...
     */
    public function health_master_index(Request $request, $first = null, $second = null)
    {
        ...
        return view('channels.health-analysis', [
            'mode' => $mode,
            'demo' => $demo,
        ]);
    }

    public function getViewHealthData(Request $request)
    {
