...
class ReviewController extends Controller
{
     ...
     */
    public function review_master_index(Request $request, $first = null, $second = null)
    {
        ...
        return view('channels.review-analysis', [
            'mode' => $mode,
            'demo' => $demo,
        ]);
    }

    public function getViewReviewData(Request $request)
    {
