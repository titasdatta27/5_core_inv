...
class TiktokController extends Controller
{
    ...
    public function getViewTiktokData(Request $request)
    {
        ...
        $percentage = Cache::remember('TiktokShop', now()->addDays(30), function () {
    ...
    public function updateAllTiktokSkus(Request $request)
    {
        try {
            ...
            // Store in cache
            Cache::put('TiktokShop', $percent, now()->addDays(30));
    ...
    public function exportTiktokAnalytics()
    {
        $tiktokData = TiktokShopDataView::all();
        ...
        // Output Download
        $fileName = 'TiktokShop_Analytics_Export_' . date('Y-m-d') . '.xlsx';
    ...
    public function downloadSample()
    {
        ...
        // Output Download
        $fileName = 'TiktokShop_Analytics_Sample.xlsx';
