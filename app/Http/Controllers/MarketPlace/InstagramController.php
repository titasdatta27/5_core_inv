...
class InstagramController extends Controller
{
    ...
    public function __construct(ApiController $apiController)
    {
     ...
     public function overallInstagram(Request $request)
    {
        ...
        return view('market-places.instagramAnalysis', [
            'mode' => $mode,
            'demo' => $demo,
    ...
    public function instagramPricingCVR(Request $request)
    {
        $mode = $request->query('mode');
        $demo = $request->query('demo');
    ...
    public function getViewInstagramData(Request $request)
    {
        ...
        $walmartDataViews = InstagramShopDataView::whereIn('sku', $skus)->get()->keyBy('sku');
        $nrValues = [];
        $listedValues = [];
        $liveValues = [];
    ...
    public function updateAllInstagramSkus(Request $request)
    {
        try {
            ...
            MarketplacePercentage::updateOrCreate(
                ['marketplace' => 'InstagramShop'],
                ['percentage' => $percent]
            );

            // Store in cache
            Cache::put('InstagramShop', $percent, now()->addDays(30));
    ...
    public function saveNrToDatabase(Request $request)
    {
        ...
        $dataView = InstagramShopDataView::firstOrNew(['sku' => $sku]);
    ...
    public function updateListedLive(Request $request)
    {
        ...
        $product = InstagramShopDataView::firstOrCreate(
            ['sku' => $request->sku],
            ['value' => []]
        );
    ...
    public function importInstagramAnalytics(Request $request)
    {
        $request->validate([
        ...
        try {
            ...
            foreach ($rows as $index => $row) {
                ...
                InstagramShopDataView::updateOrCreate(
                    ['sku' => $data['sku']],
                    ['value' => $values]
                );
    ...
    public function exportInstagramAnalytics()
    {
        $business5CoreData = InstagramShopDataView::all();
        ...
        // Output Download
        $fileName = 'Instagram_Analytics_Export_' . date('Y-m-d') . '.xlsx';
    ...
    public function downloadSample()
    {
        ...
        // Output Download
        $fileName = 'Instagram_Analytics_Sample.xlsx';
