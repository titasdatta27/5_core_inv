...
class ShortFallAnalysisController extends Controller
{
    ...
    public function getViewShortFallAnalysisData(Request $request)
    {
    ...
    public function shortFallAnalysis(Request $request)
    {
        $mode = $request->query('mode');
        $demo = $request->query('demo');

        return view('product-master.shortFallAnalysis', [
            'mode' => $mode,
            'demo' => $demo,
        ]);
    }
