...
namespace App\Http\Controllers\AdvertisementMaster\Demand_Gen_parent;
...
class GoogleNetworksController extends Controller
{
    ...
    public function GoogleNetworks(Request $request)
    {
        ...
        return view('advertisement-master.google-networks', [
            'title' => 'Google Networks',
            'subtitle' => 'Google Networks',
            'pagination_title' => 'Google Networks Analysis',
            'mode' => $mode,
            'demo' => $demo,
