...
class KwAmazonController extends Controller
{
    ...
    public function Amazon(Request $request)
    {
        ...
        $skuFlags = KwAmazon::select('sku', 'ra', 'nra', 'running', 'to_pause', 'paused')
        ->get()
        ...
        return view('advertisement-master.kwamazon', [
    ...
    public function updateCheckboxes(Request $request)
    {
        ...
        $item = KwAmazon::firstOrNew(['sku' => $sku]);
        $item->$field = $value;
        $item->save();
