@extends('layouts.vertical', ['title' => 'Scrollspy', 'mode' => $mode ?? '', 'demo' => $demo ?? ''])
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    ...
                    <p class="text-muted mb-0">Scroll the area below the navbar and watch the active class change. The
