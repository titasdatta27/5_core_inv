@extends('layouts.vertical', ['title' => 'Mercari W Ship Zero View', 'mode' => $mode ?? '', 'demo' => $demo ?? ''])
...
@section('content')
    @include('layouts.shared/page-title', ['page_title' => 'Mercari W Ship Zero View', 'sub_title' => 'Mercari W Ship'])
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            function loadData() {
                showLoader();
                return $.ajax({
                    url: '/zero_mercariwship/view-data',
                    type: 'GET',
                    dataType: 'json',
            ...
            $('#saveReasonActionBtn').on('click', function() {
                ...
                if (sku) {
                    $.ajax({
                        url: '/zero_mercariwship/reason-action/update-data',
                        method: 'POST',
                        data: {
                            sku: sku,
                            reason: reason,
