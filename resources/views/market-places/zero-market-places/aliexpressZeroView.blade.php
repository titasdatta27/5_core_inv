@extends('layouts.vertical', ['title' => 'Aliexpress Zero View', 'mode' => $mode ?? '', 'demo' => $demo ?? ''])
...
@section('content')
    @include('layouts.shared/page-title', ['page_title' => 'Aliexpress Zero View', 'sub_title' => 'Aliexpress'])

    <div class="row">
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    <h4 class="header-title">Aliexpress Zero View</h4>
                    ...
                    <div id="data-loader" class="card-loader-overlay" style="display: none;">
                        <div class="loader-content">
                            ...
                            <div class="loader-text">Loading Aliexpress Zero...</div>
                        </div>
                    </div>
                </div>
            </div>
