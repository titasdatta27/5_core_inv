@extends('layouts.vertical', ['title' => 'Shein Zero View', 'mode' => $mode ?? '', 'demo' => $demo ?? ''])
...
@section('content')
    @include('layouts.shared/page-title', ['page_title' => 'Shein Zero View', 'sub_title' => 'Shein'])
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            $('#saveReasonActionBtn').on('click', function() {
                ...
                if (sku) {
                    $.ajax({
                        url: '/zero_shein/reason-action/update-data',
                        method: 'POST',
                        data: {
                            sku: sku,
                            reason: reason,
