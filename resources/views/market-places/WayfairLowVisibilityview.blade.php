@extends('layouts.vertical', ['title' => 'Wayfair Low View', 'mode' => $mode ?? '', 'demo' => $demo ?? ''])
...
@section('content')
    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    <h4 class="header-title">Wayfair Low View </h4>
                    ...
                    <div class="table-container">
                        <table class="custom-resizable-table" id="wayfairLowVisibility-table">
                            <thead>
                                <tr>
                    ...
                    <div id="data-loader" class="card-loader-overlay" style="display: none;">
                        <div class="loader-content">
                            ...
                            <div class="loader-text">Loading Wayfair Low View data...</div>
                        </div>
                    </div>
                </div>
            </div>
...
@section('script')
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            // Cache system
            const wayfairLowVisibilityDataCache = {
                cache: {},
            ...
            window.addEventListener('load', function() {
                wayfairLowVisibilityDataCache.clear();
            });
            ...
            function loadData() {
                showLoader();
                return $.ajax({
                    url: '/Wayfaire/low-visibility/view-data',
                    type: 'GET',
                    dataType: 'json',
                    success: function(response) {
            ...
            function renderTable() {
                const $tbody = $('#wayfairLowVisibility-table tbody');
            ...
            function initNREditHandlers() {
                ...
                $(document).on('click', '.nr-edit-container .nr-edit-icon, .nr-edit-container .fa-save', function(
                    ...
                    const rowData = filteredData.find(item => item['SL No.'] == slNo || item['SL No.'] == slNo);
            ...
            window.openModal = function(selectedItem, type) {
                try {
                    ...
                    if (!cachedData) {
                        wayfairLowVisibilityDataCache.set(itemId, itemData);
                    }
            ...
            function saveChanges(contentElement, title, slNo, isHyperlink, updatedValue, isCheckbox, rowElement) {
                ...
                wayfairLowVisibilityDataCache.updateField(itemId, title, cacheUpdateValue);
                ...
                $.ajax({
                    ...
                    error: function(xhr, status, error) {
                        ...
                        // Revert cache
                        wayfairLowVisibilityDataCache.updateField(itemId, title, originalValue);
            ...
            function initResizableColumns() {
                const $table = $('#wayfairLowVisibility-table');
            ...
            $('#saveReasonActionBtn').on('click', function() {
                ...
                if (sku) {
                    $.ajax({
                        url: '/wayfair-low-visibility/reason-action/update',
                        method: 'POST',
                        data: {
                            sku: sku,
                            reason: reason,
