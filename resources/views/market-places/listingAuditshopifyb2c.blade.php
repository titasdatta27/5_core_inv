@extends('layouts.vertical', ['title' => 'Listing Audit Shopify B2C', 'mode' => $mode ?? '', 'demo' => $demo ?? ''])
...
@section('content')
    @include('layouts.shared/page-title', [
        'page_title' => 'Listing Audit Shopify B2C',
        'sub_title' => 'Shopify B2C',
    ])
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            function loadData() {
                showLoader();
                return $.ajax({
                    url: '/listing_audit_shopifyb2c/view-data',
                    type: 'GET',
                    dataType: 'json',
            ...
            function initNAEditHandlers() {
                ...
                $(document).on('change', '.na-checkbox', function(e) {
                    ...
                    $.ajax({
                        url: '/listing_audit_shopifyb2c/save-na',
                        type: 'POST',
                        data: {
                            sku: sku,
                            field: field,
