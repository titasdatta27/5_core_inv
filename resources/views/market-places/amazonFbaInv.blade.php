...
@section('content')
    @include('layouts.shared/page-title', ['page_title' => 'Amazon FBA INV AGE', 'sub_title' => 'Amazon'])
    {{-- <div class="row">
        <div class="col-12">
            <div class="card">
                <div class="card-body">
    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    <h4 class="header-title">Amazon FBA INV AGE</h4>
                        ...
                        <table class="custom-resizable-table" id="amazon-table">
                            <thead>
                                <tr>
                                    ...
                                    <th data-field="0to90_days" style="vertical-align: middle; white-space: nowrap;">
                                        <div class="d-flex flex-column align-items-center">
                                            <div class="d-flex align-items-center">
                                                0-to-90-days <span class="sort-arrow">↓</span>
                                            </div>
                                        </div>
                                    </th>
                                    <th data-field="91to180_days" style="vertical-align: middle; white-space: nowrap;">
                                        <div class="d-flex flex-column align-items-center">
                                            <div class="d-flex align-items-center">
                                                91-to-180-days <span class="sort-arrow">↓</span>
                                            </div>
                                        </div>
                                    </th>
                                    <th data-field="181to270_days" style="vertical-align: middle; white-space: nowrap;">
                                        <div class="d-flex flex-column align-items-center">
                                            <div class="d-flex align-items-center">
                                                181-to-270-days <span class="sort-arrow">↓</span>
                                            </div>
                                        </div>
                                    </th>
                                    <th data-field="271to365_days" style="vertical-align: middle; white-space: nowrap;">
                                        <div class="d-flex flex-column align-items-center">
                                            <div class="d-flex align-items-center">
                                                271-to-365-days <span class="sort-arrow">↓</span>
                                            </div>
                                        </div>
                                    </th>
                                    <th data-field="365plus_days" style="vertical-align: middle; white-space: nowrap;">
                                        <div class="d-flex flex-column align-items-center">
                                            <div class="d-flex align-items-center">
                                                365-plus-days <span class="sort-arrow">↓</span>
                                            </div>
                                        </div>
                                    </th>
                    ...
                    <div id="data-loader" class="card-loader-overlay" style="display: none;">
                        <div class="loader-content">
                            ...
                            <div class="loader-text">Loading FBA INV AGE data...</div>
                        </div>
                    </div>
                </div>
            </div>
        ...
        $(document).ready(function() {
                        ...
                        if (response && response.data) {
                            tableData = response.data.map((item, index) => {
                                ...
                                return {
                                    ...
                                    FL30: item.FL30 || 0,
                                    'FDil%': item['FDil%'] || 0,
                                    '0-to-90-days': item['0-to-90-days'] || 0,
                                    '91-to-180-days': item['91-to-180-days'] || 0,
                                    '181-to-270-days': item['181-to-270-days'] || 0,
                                    '271-to-365-days': item['271-to-365-days'] || 0,
                                    '365-plus-days': item['365-plus-days'] || 0,
                                    'FAMZ': item['FAMZ'] || 0,
                                    'FP%': item['FP%'] || 0,
                                    'FRoi': item['FRoi'] || 0,
            ...
            function renderTable() {
                ...
                filteredData.forEach(item => {
                    ...
                    $row.append($('<td>').html(
                        `<span class="dil-percent-value ">${(Number(item['0-to-90-days']) || 0).toFixed(2)}%</span>`
                    ));
                    $row.append($('<td>').html(
                        `<span class="dil-percent-value ${getDaysColor(item['91-to-180-days'])}">${(Number(item['91-to-180-days']) * 100 || 0).toFixed(2)}%</span>`
                    ));
                    $row.append($('<td>').html(
                        `<span class="dil-percent-value ${getDaysColor(item['181-to-270-days'])}">${(Number(item['181-to-270-days']) * 100 || 0).toFixed(2)}%</span>`
                    ));
                    $row.append($('<td>').html(
                        `<span class="dil-percent-value ${getDaysColor(item['271-to-365-days'])}">${(Number(item['271-to-365-days']) * 100 || 0).toFixed(2)}%</span>`
                    ));
                    $row.append($('<td>').html(
                        `<span class="dil-percent-value ${getDaysColor(item['365-plus-days'])}">${(Number(item['365-plus-days']) * 100 || 0).toFixed(2)}%</span>`
                    ));
                    ...
                    $row.append($('<td>').html(
                        `<span class="dil-percent-value ${getFPColor(item['FP%'])}">${(Number(item['FP%']) * 100 || 0).toFixed(2)}%</span>`
                    ));

                    $row.append($('<td>').html(
                        `<span class="dil-percent-value ${getFRoiColor(item.FRoi)}">${(Number(item.FRoi) * 100 || 0).toFixed(2)}%</span>`
                    ));
            ...
            //             showNotification('success', 'NR updated successfully');
            //             if (nrValue === 'NR') {
            //                 $select.css('background-color', '#dc3545'); // green
            //                 $select.css('color', '#ffffff');
            //             } else if (nrValue === 'REQ') {
            //                 $select.css('background-color', '#28a745'); // red
            //                 $select.css('color', '#ffffff');
            //             } else {
            //                 // Reset color if some other value
