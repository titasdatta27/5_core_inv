@extends('layouts.vertical', ['title' => 'Newegg B2C Low View', 'mode' => $mode ?? '', 'demo' => $demo ?? ''])
...
@section('content')
    @include('layouts.shared/page-title', [
        'page_title' => 'Newegg B2C Low View',
    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    <h4 class="header-title">Newegg B2C Low View </h4>
                    ...
                    <div class="table-container">
                        <table class="custom-resizable-table" id="neweggb2cLowVisibilty-table">
                            <thead>
                                <tr>
                    ...
                    <div id="data-loader" class="card-loader-overlay" style="display: none;">
                        <div class="loader-content">
                            ...
                            <div class="loader-text">Loading Newegg B2C Low View data...</div>
                        </div>
                    </div>
                </div>
            </div>
        ...
        $(document).ready(function() {
            $('#editPercentBtn').on('click', function() {
                ...
                if ($icon.hasClass('fa-pen')) {
                    ...
                    $.ajax({
                        // url: '/update-all-neweggb2cLowVisibilty-skus',
                        type: 'POST',
                        data: {
                            percent: percent,
            ...
            // Cache system
            const neweggb2cLowVisibiltyDataCache = {
                cache: {},
            ...
            window.addEventListener('load', function() {
                neweggb2cLowVisibiltyDataCache.clear();
            });
            ...
            function loadData() {
                showLoader();
                return $.ajax({
                    url: '/Neweggb2c/low-visiblity/view-data',
                    type: 'GET',
                    dataType: 'json',
                    success: function(response) {
            ...
            function renderTable() {
                const $tbody = $('#neweggb2cLowVisibilty-table tbody');
            ...
            function initNREditHandlers() {
                ...
                $(document).on('click', '.nr-edit-container .nr-edit-icon, .nr-edit-container .fa-save', function(
                    ...
                    const rowData = filteredData.find(item => item['Sl No.'] == slNo || item['SL No.'] ==
                        slNo);
            ...
            window.openModal = function(selectedItem, type) {
                try {
                    ...
                    const cachedData = neweggb2cLowVisibiltyDataCache.get(itemId);
                    const dataToUse = cachedData || itemData;

                    // Store the data in cache if it wasn't already
                    if (!cachedData) {
                        neweggb2cLowVisibiltyDataCache.set(itemId, itemData);
                    }
            ...
            function saveChanges(contentElement, title, slNo, isHyperlink, updatedValue, isCheckbox, rowElement) {
                ...
                neweggb2cLowVisibiltyDataCache.updateField(itemId, title, cacheUpdateValue);
                ...
                if (title === 'S Price') {
                    ...
                    if (cachedData) {
                        ...
                        neweggb2cLowVisibiltyDataCache.updateField(itemId, 'SugPFT%', roundedSpft / 100);
                ...
                $.ajax({
                    ...
                    error: function(xhr, status, error) {
                        ...
                        // Revert cache
                        neweggb2cLowVisibiltyDataCache.updateField(itemId, title, originalValue);
                        if (title === 'S Price') {
                            ...
                            if (originalSpft !== undefined) {
                                neweggb2cLowVisibiltyDataCache.updateField(itemId, 'SugPFT%', originalSpft);
                            }
                        }
            ...
            function initResizableColumns() {
                const $table = $('#neweggb2cLowVisibilty-table');
            ...
            $('#saveReasonActionBtn').on('click', function() {
                ...
                if (sku) {
                    $.ajax({
                        url: '/neweggb2c-low-visibility/reason-action/update',
                        method: 'POST',
                        data: {
                            sku: sku,
                            reason: reason,
