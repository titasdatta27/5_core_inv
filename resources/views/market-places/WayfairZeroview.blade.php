@extends('layouts.vertical', ['title' => 'Wayfair Zero View', 'mode' => $mode ?? '', 'demo' => $demo ?? ''])
...
@section('content')
    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    <h4 class="header-title">Wayfair Zero View </h4>
                    ...
                    <div id="data-loader" class="card-loader-overlay" style="display: none;">
                        <div class="loader-content">
                            ...
                            <div class="loader-text">Loading Wayfair Zero View data...</div>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            $('#saveReasonActionBtn').on('click', function() {
                ...
                if (sku) {
                    $.ajax({
                        url: '/wayfair-zero/reason-action/update',
                        method: 'POST',
                        data: {
                            sku: sku,
                            reason: reason,
