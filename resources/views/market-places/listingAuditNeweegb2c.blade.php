@extends('layouts.vertical', ['title' => 'Listing Audit Neweeg B2C', 'mode' => $mode ?? '', 'demo' => $demo ?? ''])
...
@section('content')
    @include('layouts.shared/page-title', [
        'page_title' => 'Listing Audit Neweeg B2C',
        'sub_title' => 'Neweeg B2C',
    ])
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="table-container">
                        <table class="custom-resizable-table" id="neweeggb2c-table">
                            <thead>
                                <tr>
...
@section('script')
    ...
    <script>
        ...
        $(document).ready(function() {
            // Cache system
            const neweeggb2cListingAuditDataCache = {
                cache: {},
            ...
            window.addEventListener('load', function() {
                neweeggb2cListingAuditDataCache.clear();
            });
            ...
            function loadData() {
                showLoader();
                return $.ajax({
                    url: '/listing_audit_neweggb2c/view-data',
                    type: 'GET',
                    dataType: 'json',
            ...
            function renderTable() {
                const $tbody = $('#neweeggb2c-table tbody');
                $tbody.empty();
            ...
            function initNAEditHandlers() {
                ...
                $(document).on('change', '.na-checkbox', function(e) {
                    ...
                    $.ajax({
                        url: '/listing_audit_neweggb2c/save-na',
                        type: 'POST',
                        data: {
                            sku: sku,
                            field: field,
