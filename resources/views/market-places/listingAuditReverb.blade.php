@extends('layouts.vertical', ['title' => 'Listing Audit Reverb', 'mode' => $mode ?? '', 'demo' => $demo ?? ''])
...
@section('content')
    @include('layouts.shared/page-title', [
        'page_title' => 'Listing Audit Reverb',
        'sub_title' => 'Reverb',
    ])
...
@section('script')
    ...
    <script>
        ...
        $(document).ready(function() {
            // Cache system
            const reverbListingAuditDataCache = {
                cache: {},
            ...
            window.addEventListener('load', function() {
                reverbListingAuditDataCache.clear();
            });
            ...
            function loadData() {
                showLoader();
                return $.ajax({
                    url: '/listing_audit_reverb/view-data',
                    type: 'GET',
                    dataType: 'json',
            ...
            function initNAEditHandlers() {
                ...
                $(document).on('change', '.na-checkbox', function(e) {
                    ...
                    $.ajax({
                        url: '/listing_audit_reverb/save-na',
                        type: 'POST',
                        data: {
                            sku: sku,
                            field: field,
