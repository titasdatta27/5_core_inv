@extends('layouts.vertical', ['title' => `Listing Audit Macy's`, 'mode' => $mode ?? '', 'demo' => $demo ?? ''])
...
@section('content')
    @include('layouts.shared/page-title', [
        'page_title' => `Listing Audit Macy's`,
        'sub_title' => `Macy's`,
    ])
...
@section('script')
    ...
    <script>
        ...
        $(document).ready(function() {
            // Cache system
            const macyListingAuditDataCache = {
                cache: {},
            ...
            window.addEventListener('load', function() {
                macyListingAuditDataCache.clear();
            });
            ...
            function loadData() {
                showLoader();
                return $.ajax({
                    url: '/listing_audit_macy/view-data',
                    type: 'GET',
                    dataType: 'json',
            ...
            function initNAEditHandlers() {
                ...
                $(document).on('change', '.na-checkbox', function(e) {
                    ...
                    $.ajax({
                        url: '/listing_audit_macy/save-na',
                        type: 'POST',
                        data: {
                            sku: sku,
                            field: field,
