            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="table-container">
                        <table class="custom-resizable-table" id="wayfaireListing-table">
                            <thead>
                                <tr>
...
@section('script')
    ...
    <script>
        ...
        $(document).ready(function() {
            // Cache system
            const wayfaireListingDataCache = {
                cache: {},
            ...
            window.addEventListener('load', function() {
                wayfaireListingDataCache.clear();
            });
            ...
            function renderTable() {
                const $tbody = $('#wayfaireListing-table tbody');
                $tbody.empty();
            ...
            function initResizableColumns() {
                const $table = $('#wayfaireListing-table');
            ...
            function saveStatusToDB(sku, data) {
                $.ajax({
                    url: '/listing_wayfair/save-status',
                    type: 'POST',
                    data: {
                        sku: sku,
                        ...data,
