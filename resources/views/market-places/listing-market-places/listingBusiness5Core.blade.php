@extends('layouts.vertical', ['title' => 'Listing Business 5Core', 'mode' => $mode ?? '', 'demo' => $demo ?? ''])
...
@section('content')
    @include('layouts.shared.page-title', ['page_title' => 'Listing Business 5Core', 'sub_title' => 'Business 5Core'])
                ...
                <div class="card-body">
                    ...
                    <div class="d-flex justify-content-between align-items-center mb-3">
                        ...
                        <div class="d-flex align-items-center mb-3 gap-2">
                            ...
                            <a href="{{ route('listing_business5core.export') }}" class="btn btn-sm btn-success mr-3">Export</a>
                    ...
                    <div class="table-container">
                        <table class="custom-resizable-table" id="business5CoreListing-table">
                            <thead>
                                <tr>
...
@section('script')
    ...
    <script>
        ...
        $(document).ready(function() {
            // Cache system
            const business5CoreListingDataCache = {
                cache: {},
            ...
            window.addEventListener('load', function() {
                business5CoreListingDataCache.clear();
            });
            ...
            function loadData() {
                showLoader();
                return $.ajax({
                    url: '/listing_business5core/view-data',
                    type: 'GET',
                    dataType: 'json',
            ...
            function renderTable() {
                const $tbody = $('#business5CoreListing-table tbody');
                $tbody.empty();
            ...
            $(document).on('click', '#confirmImportBtn', function () {
                ...
                $.ajax({
                    url: "{{ route('listing_business5core.import') }}",
                    type: "POST",
                    data: formData,
                    processData: false,
                    contentType: false,
            ...
            function initResizableColumns() {
                const $table = $('#business5CoreListing-table');
            ...
            function saveStatusToDB(sku, data) {
                $.ajax({
                    url: '/listing_business5core/save-status',
                    type: 'POST',
                    data: {
                        sku: sku,
                        ...data,
