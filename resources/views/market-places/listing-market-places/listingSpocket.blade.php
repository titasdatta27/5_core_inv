@extends('layouts.vertical', ['title' => 'Listing Spocket', 'mode' => $mode ?? '', 'demo' => $demo ?? ''])
...
@section('content')
    @include('layouts.shared.page-title', ['page_title' => 'Listing Spocket', 'sub_title' => 'Spocket'])
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="table-container">
                        <table class="custom-resizable-table" id="spocketListing-table">
                            <thead>
                                <tr>
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            function renderTable() {
                const $tbody = $('#spocketListing-table tbody');
                $tbody.empty();
            ...
            function initResizableColumns() {
                const $table = $('#spocketListing-table');
            ...
            function saveStatusToDB(sku, data) {
                $.ajax({
                    url: '/listing_spocket/save-status',
                    type: 'POST',
                    data: {
                        sku: sku,
                        ...data,
