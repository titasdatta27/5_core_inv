            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="table-container">
                        <table class="custom-resizable-table" id="neweggB2BListing-table">
                            <thead>
                                <tr>
...
@section('script')
    ...
    <script>
        ...
        $(document).ready(function() {
            // Cache system
            const neweggB2BListingDataCache = {
                cache: {},
            ...
            window.addEventListener('load', function() {
                neweggB2BListingDataCache.clear();
            });
            ...
            function loadData() {
                showLoader();
                return $.ajax({
                    url: '/listing_neweggb2b/view-data',
                    type: 'GET',
                    dataType: 'json',
            ...
            function renderTable() {
                const $tbody = $('#neweggB2BListing-table tbody');
                $tbody.empty();
            ...
            function initResizableColumns() {
                const $table = $('#neweggB2BListing-table');
