@extends('layouts.vertical', ['title' => 'Listing Mercari w Ship', 'mode' => $mode ?? '', 'demo' => $demo ?? ''])
...
@section('content')
    @include('layouts.shared.page-title', ['page_title' => 'Listing Mercari w Ship', 'sub_title' => 'Mercari w Ship'])
                ...
                <div class="card-body">
                    ...
                    <div class="d-flex justify-content-between align-items-center mb-3">
                        ...
                        <div class="d-flex align-items-center mb-3 gap-2">
                            ...
                            <a href="{{ route('listing_mercariwship.export') }}" class="btn btn-sm btn-success mr-3">Export</a>
                    ...
                    <div class="table-container">
                        <table class="custom-resizable-table" id="mercariWShipListing-table">
                            <thead>
                                <tr>
...
@section('script')
    ...
    <script>
        ...
        $(document).ready(function() {
            // Cache system
            const mercariWShipListingDataCache = {
                cache: {},
            ...
            window.addEventListener('load', function() {
                mercariWShipListingDataCache.clear();
            });
            ...
            function loadData() {
                showLoader();
                return $.ajax({
                    url: '/listing_mercariwship/view-data',
                    type: 'GET',
                    dataType: 'json',
            ...
            function renderTable() {
                const $tbody = $('#mercariWShipListing-table tbody');
                $tbody.empty();
            ...
            $(document).on('click', '#confirmImportBtn', function () {
                ...
                $.ajax({
                    url: "{{ route('listing_mercariwship.import') }}",
                    type: "POST",
                    data: formData,
                    processData: false,
                    contentType: false,
            ...
            function initResizableColumns() {
                const $table = $('#mercariWShipListing-table');
            ...
            function saveStatusToDB(sku, data) {
                $.ajax({
                    url: '/listing_mercariwship/save-status',
                    type: 'POST',
                    data: {
                        sku: sku,
                        ...data,
