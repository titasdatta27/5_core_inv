@extends('layouts.vertical', ['title' => 'Listing Shoipify Wholesale', 'mode' => $mode ?? '', 'demo' => $demo ?? ''])
...
@section('content')
    @include('layouts.shared/page-title', ['page_title' => 'Listing Shoipify Wholesale', 'sub_title' => 'Shoipify Wholesale'])
                ...
                <div class="card-body">
                    ...
                    <div class="d-flex justify-content-between align-items-center mb-3">
                        ...
                        <div class="d-flex align-items-center mb-3 gap-2">
                            ...
                            <a href="{{ route('listing_shopifywholesale.export') }}" class="btn btn-sm btn-success mr-3">Export</a>
                    ...
                    <div class="table-container">
                        <table class="custom-resizable-table" id="shopifyWholesaleListing-table">
                            <thead>
                                <tr>
...
@section('script')
    ...
    <script>
        ...
        $(document).ready(function() {
            // Cache system
            const shopifyWholesaleListingDataCache = {
                cache: {},
            ...
            window.addEventListener('load', function() {
                shopifyWholesaleListingDataCache.clear();
            });
            ...
            function loadData() {
                showLoader();
                return $.ajax({
                    url: '/listing_shopifywholesale/view-data',
                    type: 'GET',
                    dataType: 'json',
            ...
            function renderTable() {
                const $tbody = $('#shopifyWholesaleListing-table tbody');
                $tbody.empty();
            ...
            $(document).on('click', '#confirmImportBtn', function () {
                ...
                $.ajax({
                    url: "{{ route('listing_shopifywholesale.import') }}",
                    type: "POST",
                    data: formData,
                    processData: false,
                    contentType: false,
            ...
            function initResizableColumns() {
                const $table = $('#shopifyWholesaleListing-table');
            ...
            function saveStatusToDB(sku, data) {
                $.ajax({
                    url: '/listing_shopifywholesale/save-status',
                    type: 'POST',
                    data: {
                        sku: sku,
                        ...data,
