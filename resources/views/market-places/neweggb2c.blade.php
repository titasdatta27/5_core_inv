@extends('layouts.vertical', ['title' => 'Newegg B2C', 'mode' => $mode ?? '', 'demo' => $demo ?? ''])
...
@section('content')
    @include('layouts.shared/page-title', ['page_title' => 'Newegg B2C', 'sub_title' => 'Marketplace'])
                    ...
                    <div id="percent-edit-div" class="d-flex align-items-center">
                        <div class="input-group" style="width: 150px;">
                            <input type="number" id="updateAllSkusPercent" class="form-control" min="0"
                                max="100" value="{{ $neweggb2cPercentage }}" step="0.01" title="Percent" disabled />
    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    <h4 class="header-title">Newegg B2C Product Analysis</h4>
                    ...
                    <div class="d-flex flex-wrap gap-2 mb-3">
                        ...
                        <!-- A Dil% Filter -->
                        <div class="dropdown manual-dropdown-container">
                            <button class="btn btn-light dropdown-toggle" type="button" id="nDilFilterDropdown">
                                <span class="status-circle default"></span> N DIL%
                            </button>
                            <ul class="dropdown-menu" aria-labelledby="nDilFilterDropdown">
                    ...
                    <div class="table-container">
                        <table class="custom-resizable-table" id="neweggb2c-table">
                            <thead>
                                <tr>
                                    ...
                                    <th data-field="nl_30" style="vertical-align: middle; white-space: nowrap;">
                                        <div class="d-flex flex-column align-items-center" style="gap: 4px">
                                            <div class="d-flex align-items-center">
                                                N L30 <span class="sort-arrow">↓</span>
                                            </div>
                                            <div style="width: 100%; height: 5px; background-color: #9ec7f4;"></div>
                                            <div class="metric-total" id="nl30-total">0</div>
                                        </div>
                                    </th>
                                    <th data-field="sh_dil" style="vertical-align: middle; white-space: nowrap;">
                                        <div class="d-flex flex-column align-items-center" style="gap: 4px">
                                            <div class="d-flex align-items-center">
                                                N DIL <span class="sort-arrow">↓</span>
                                            </div>
                                            <div style="width: 100%; height: 5px; background-color: #9ec7f4;"></div>
                                    ...
                                    <th>NRL</th>
                                    <th data-field="session" style="vertical-align: middle; white-space: nowrap;">
                                        <div class="d-flex flex-column align-items-center" style="gap: 4px">
                                            <div class="d-flex align-items-center">
                                                SESSIONS <span class="sort-arrow">↓</span>
                                            </div>
                                            <div style="width: 100%; height: 5px; background-color: #9ec7f4;"></div>
                                            <div class="metric-total" id="session-total">0</div>
                                        </div>
                                    </th>
                                    <th data-field="price"
                                        style="vertical-align: middle; white-space: nowrap; padding-right: 4px;">
                    ...
                    <div id="data-loader" class="card-loader-overlay" style="display: none;">
                        <div class="loader-content">
                            ...
                            <div class="loader-text">Loading Newegg B2C data...</div>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            const statusIndicatorFields = {
                'price view': ['PFT %', 'TPFT', 'ROI', 'SugPFT%', 'SROI'],
                        ...
                        if (response && response.data) {
                            tableData = response.data.map((item, index) => {
                                return {
                                    ...
                                    'N L30': item['N L30'] || 0,
                                    'N DIL%': item['N DIL%'] || 0,
                                    session: item['SESS L30'] || 0,
                                    Price: Number(item['Newegg Price']) || 0,
                                    'PFT %': item['PFT%'] || 0,
                                    Roi: item['ROI'] || 0,
                                    Lmp: item['Lmp'] || 0,
                                    Tacos30: item.TacosL30 || 0,
                                    SCVR: Number(item['SCVR L30']) || 0,
            ...
            function updateSoldCounts() {
                ...
                filteredData.forEach(item => {
                    if (!item.is_parent) {
                        const l30 = parseFloat(item['N L30']) || 0;
            ...
            function renderTable() {
                const $tbody = $('#neweggb2c-table tbody');
                $tbody.empty();
                ...
                filteredData.forEach(item => {
                    ...
                    if (item.is_parent) {
                        ...
                        const buyerLink = item.raw_data['Buyer Link'] || '';
                        const sellerLink = item.raw_data['Seller Link'] || '';
                        const lLink = item.raw_data['Comp Link'] || '';
                            ...
                            $skuCell.html(`
                                <div class="sku-tooltip-container">
                                    ...
                                    <div class="sku-tooltip">
                                        ...
                                        ${lLink ? `<div class="sku-link"><a href="${lLink}" target="_blank" rel="noopener noreferrer">L link</a></div>` : ''}
                                    </div>
                                </div>
                            `);
                        } else {
                    ...
                    $row.append($('<td>').text(item['N L30']));

                    // A DIL with color coding
                    $row.append($('<td>').html(
                        `<span class="dil-percent-value ${getDilColor(item['N DIL%'])}">${Math.round(item['N DIL%'] * 100)}%</span>`
                    ));
                    ...
                    // session with tooltip icon (no color coding)
                    $row.append($('<td>').html(
                        `<span>${Math.round(item.session)}%</span>
                    ...
                    $row.append($('<td>').text(
                        typeof item.Lmp === 'number' ? item.Lmp.toFixed(2) : 0
                    ));
            ...
            window.openModal = function(selectedItem, type) {
                try {
                    ...
                    const cachedData = neweggb2cDataCache.get(itemId);
                    const dataToUse = cachedData || itemData;

                    // Store the data in cache if it wasn't already
                    if (!cachedData) {
                        neweggb2cDataCache.set(itemId, itemData);
                    }
                    ...
                    switch (type.toLowerCase()) {
                        ...
                        case 'visibility view':
                            fieldsToDisplay = [{
                                    title: 'SESS L30',
                                    content: selectedItem['SESS L30']
                                },
                                {
                                    title: 'SCVR L30',
                                    content: selectedItem['SCVR L30']
                                }
                            ];
                            break;
                        case 'price view':
                            fieldsToDisplay = [{
                                ...
                                {
                                    title: 'Newegg Price',
                                    content: selectedItem['Newegg Price']
                                },
                                {
                                    title: 'PFT%',
                                ...
                                {
                                    title: 'Comp Link',
                                    content: selectedItem['Comp Link']
                                },
                                {
                                    title: 'S MSRP',
                                    content: selectedItem['S MSRP']
                                },
                                {
                                    title: 'Sprice',
                                ...
                                {
                                    title: 'SugPFT%',
                                    content: dataToUse['SugPFT%'] !== 0 ? dataToUse['SugPFT%'] : '0 %'
                                },
                                {
                                    title: 'SROI',
            ...
            function getIndicatorColor(fieldTitle, fieldValue, type) {
                ...
                if (type === 'price view') {
                    if (['PFT%', 'TPFT', 'SugPFT%'].includes(fieldTitle)) {
            ...
            function createFieldCard(field, data, type, itemId) {
                const hyperlinkFields = ['Comp Link'];

                const percentageFields = ['ROI', 'PFT%', 'CtrY', 'SROI'];
            ...
            function setupEditHandlers(modalId) {
                ...
                const editableFields = ['Lmp', 'Comp Link', 'Sprice'];
            ...
            function saveChanges(contentElement, title, slNo, isHyperlink, updatedValue, isCheckbox, rowElement) {
                ...
                neweggb2cDataCache.updateField(itemId, title, cacheUpdateValue);
                ...
                if (title === 'S Price') {
                    ...
                    if (cachedData) {
                        ...
                        // Calculate SugPFT%: (S Price * 0.75 - LP - WT) / S Price * 100
                        ...
                        // Update SugPFT% in cache only (not in server data)
                        neweggb2cDataCache.updateField(itemId, 'SugPFT%', roundedSpft / 100);

                        // Update the filteredData array to reflect the SPFT% change
                        const index = filteredData.findIndex(item => item['Sl No.'] == itemId);
                        if (index !== -1) {
                            filteredData[index]['SugPFT%'] = roundedSpft / 100;
                            if (filteredData[index].raw_data) {
                                filteredData[index].raw_data['SugPFT%'] = roundedSpft / 100;
                            }
                        }

                        // Find and update the SugPFT% display in the modal if it exists
                        const modalId = card.closest('.custom-modal').attr('id');
                        if (modalId) {
                            const spftCard = $('#' + modalId).find('.card-title:contains("SugPFT%")').closest(
                                '.card');
                            if (spftCard.length) {
                                ...
                                const indicatorColor = getIndicatorColor('SugPFT%', roundedSpft / 100,
                                    'price view');
                ...
                $.ajax({
                    ...
                    //     '/public' : '') + '/api/update-neweggb2c-column',
                    ...
                    error: function(xhr, status, error) {
                        ...
                        // Revert cache
                        neweggb2cDataCache.updateField(itemId, title, originalValue);
                        if (title === 'S Price') {
                            ...
                            if (originalSpft !== undefined) {
                                neweggb2cDataCache.updateField(itemId, 'SugPFT%', originalSpft);
                            }
                        }
                        ...
                        if (index !== -1) {
                            ...
                            if (title === 'S Price' && originalSpft !== undefined) {
                                filteredData[index]['SugPFT%'] = originalSpft;
                                if (filteredData[index].raw_data) {
                                    filteredData[index].raw_data['SugPFT%'] = originalSpft;
                                }
                            }
                            if (filteredData[index].raw_data) {
            ...
            function calculateTotals() {
                try {
                    ...
                    filteredData.forEach(item => {
                        ...
                        metrics.nl30Total += parseFloat(item['N L30']) || 0;
                        metrics.shDilTotal += parseFloat(item['N DIL%']) || 0;
                        metrics.sessionTotal += parseFloat(item['SESS L30']) || 0;
                        metrics.tacosTotal += parseFloat(item.Tacos30) || 0;
                        metrics.pftSum += parseFloat(item['PFT %']) || 0;
                        metrics.roiSum += parseFloat(item.ROI) || 0;
                        metrics.scvrSum += parseFloat(item['SCVR L30']) || 0;
                        metrics.rowCount++;
                    });
                    ...
                    $('#nl30-total').text(metrics.nl30Total.toLocaleString());
                    $('#shDil-total').text(Math.round(metrics.shDilTotal / divisor * 100) + '%');
                    $('#session-total').text(metrics.sessionTotal.toLocaleString());
