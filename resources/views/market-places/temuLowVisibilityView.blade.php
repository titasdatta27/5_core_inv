...
@section('content')
    @include('layouts.shared/page-title', ['page_title' => 'Temu Low View', 'sub_title' => 'MArket Place'])

    <div class="row">
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    <h4 class="header-title">Temu Low View</h4>
                    ...
                    <div class="table-container">
                        <table class="custom-resizable-table" id="temuLowVisibility-table">
                            <thead>
                                <tr>
                    ...
                    <div id="data-loader" class="card-loader-overlay" style="display: none;">
                        <div class="loader-content">
                            ...
                            <div class="loader-text">Loading Temu Low View data...</div>
                        </div>
                    </div>
                </div>
            </div>
...
@section('script')
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            // Cache system
            const temuLowVisibilityDataCache = {
                cache: {},
            ...
            window.addEventListener('load', function() {
                temuLowVisibilityDataCache.clear();
            });
            ...
            function loadData() {
                showLoader();
                return $.ajax({
                    url: '/Temu/low-visibility/view-data',
                    type: 'GET',
                    dataType: 'json',
                    success: function(response) {
            ...
            function renderTable() {
                const $tbody = $('#temuLowVisibility-table tbody');
            ...
            window.openModal = function(selectedItem, type) {
                try {
                    ...
                    if (!cachedData) {
                        temuLowVisibilityDataCache.set(itemId, itemData);
                    }
            ...
            function saveChanges(contentElement, title, slNo, isHyperlink, updatedValue, isCheckbox, rowElement) {
                ...
                temuLowVisibilityDataCache.updateField(itemId, title, cacheUpdateValue);
                ...
                if (index !== -1) {
                    ...
                    if (title === 'SPRICE' && filteredData[index].raw_data) {
                        ...
                        temuLowVisibilityDataCache.updateField(itemId, 'Spft%', Spft);
                ...
                $.ajax({
                    ...
                    error: function(xhr, status, error) {
                        ...
                        // Revert cache
                        temuLowVisibilityDataCache.updateField(itemId, title, originalValue);
            ...
            function initResizableColumns() {
                const $table = $('#temuLowVisibility-table');
            ...
            $('#saveReasonActionBtn').on('click', function() {
                ...
                if (sku) {
                    $.ajax({
                        url: '/temu-low-visibility/reason-action/update',
                        method: 'POST',
                        data: {
                            sku: sku,
                            reason: reason,
