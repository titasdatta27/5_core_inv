        ...
        <div class="col-xl-12">
            <div class="card">
                <div class="card-header">
                    ...
                    <p class="text-muted mb-0">By adding a <code>.bg-gradient</code> class, a linear gradient is added as
        ...
        <div class="col-xl-12">
            <div class="card">
                <div class="card-header">
                    ...
                    <p class="text-muted mb-0">Colorize text with color utilities. If you want to colorize links, you can
                        use the <code>.link-*</code> helper classes which have <code>:hover</code>
            ...
            <div class="col-xl-12">
                <div class="card">
                    <div class="card-header">
                        ...
                        <p class="text-muted mb-0">Use border utilities to <b>add</b> an element’s borders. Choose from all
            ...
            <div class="col-xl-12">
                <div class="card">
                    <div class="card-header">
                        ...
                        <p class="text-muted mb-0">Height utilities are generated from the utility API in
                            <code>_utilities.scss</code>. Includes support for
                            <code>25%</code>, <code>50%</code>, <code>75%</code>, <code>100%</code>, and <code>auto</code>
                            by default. Modify
                            those values as you need to generate different utilities here.
