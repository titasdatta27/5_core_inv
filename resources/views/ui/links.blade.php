        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    ...
                    <p class="text-muted mb-0">You can use the <code>.link-*</code> classes to colorize links. Unlike the <a
                            href="ui-utilities.html"><code>.text-*</code> classes</a>, these classes have a
            ...
            <div class="card">
                <div class="card-header">
                    ...
                    <p class="text-muted mb-0"><a href="ui-utilities.html">Colored link helpers</a> have been updated to
                        pair with our link utilities. Use the new utilities to modify the link opacity, underline opacity,
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <p><a href="#" class="text-decoration-underline link-underline-secondary">Secondary
                            underline</a></p>
                    <p><a href="#" class="text-decoration-underline link-underline-success">Success underline</a>
                    </p>
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    ...
                    <p class="text-muted mb-0">Change the underline’s opacity. Requires adding <code>.link-underline</code>
