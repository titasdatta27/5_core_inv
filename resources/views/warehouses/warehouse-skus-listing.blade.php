@extends('layouts.vertical', ['title' => 'Warehouse-Sku Listing', 'mode' => $mode ?? '', 'demo' => $demo ?? ''])
...
@section('content')
    @include('layouts.shared/page-title', [
        'page_title' => 'Warehouse-Sku Listing',
        'sub_title' => 'Warehouse wise skus',
    ])
    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    <h4>{{ $warehouse->name }} Wise SKUs</h4>
