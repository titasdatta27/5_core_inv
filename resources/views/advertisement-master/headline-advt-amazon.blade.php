@extends('layouts.vertical', ['title' => 'Headline Amazon', 'mode' => $mode ?? '', 'demo' => $demo ?? ''])
    ...
    <script>
        ...
        function findSheetBySKU(sku) {
            ...
            return campaignSheetData.find(item => {
                ...
                return campaignName.endsWith(' HEAD') && campaignName.startsWith(normalizedSKU);
            });
        }
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            function getDilColorClass(dilValue) {
                const val = parseFloat(dilValue);
                if (isNaN(val)) return '';
                if (val < 16.66) return 'dil-red';
                if (val < 25) return 'dil-yellow';
                if (val < 50) return 'dil-green';
                return 'dil-pink';
            }
