            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="table-container">
                        <table class="custom-resizable-table" id="google-shopppiing-table">
                            <thead>
                                <tr>
...
@section('script')
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            function renderTable() {
                const $tbody = $('#google-shopppiing-table tbody');
                $tbody.empty();
    ...
    `));
            ...
            function initResizableColumns() {
                const $table = $('#google-shopppiing-table');
