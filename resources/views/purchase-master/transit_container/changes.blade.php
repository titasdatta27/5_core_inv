@extends('layouts.vertical', ['title' => 'Transit Container Changes'])
@section('css')
...
@section('content')
@include('layouts.shared.page-title', ['page_title' => 'Transit Container Changes', 'sub_title' => 'Transit Container Changes'])
