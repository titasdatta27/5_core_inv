        ...
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <!-- DataTable -->
                    <table id="row-callback-datatable" class="table table-bordered table-hover dt-responsive nowrap w-100">
                        <thead class="table-light">
                            <tr>
                                <th class="align-middle text-center" style="background-color: #f8f9fa; min-width: 60px;">Sl No</th>
                                <th class="align-middle" style="background-color: #f8f9fa; min-width: 120px;">Parent</th>
                                <th class="align-middle" style="background-color: #f8f9fa; min-width: 120px;">SKU</th>
                                <th class="align-middle text-center" style="background-color: #f8f9fa; min-width: 80px;">INV</th>
                                <th class="align-middle text-center" style="background-color: #f8f9fa; min-width: 80px;">OV L30</th>
                                <th class="align-middle text-center" style="background-color: #f8f9fa; min-width: 80px;">DIL</th>
                                
                                <!-- Monthly columns with gradient background -->
                                <th class="align-middle text-center" style="background: linear-gradient(180deg, #f8f9fa 0%, #e9ecef 100%); min-width: 70px;">JAN</th>
                                <th class="align-middle text-center" style="background: linear-gradient(180deg, #f8f9fa 0%, #e9ecef 100%); min-width: 70px;">FEB</th>
                                <th class="align-middle text-center" style="background: linear-gradient(180deg, #f8f9fa 0%, #e9ecef 100%); min-width: 70px;">MAR</th>
                                <th class="align-middle text-center" style="background: linear-gradient(180deg, #f8f9fa 0%, #e9ecef 100%); min-width: 70px;">APR</th>
                                <th class="align-middle text-center" style="background: linear-gradient(180deg, #f8f9fa 0%, #e9ecef 100%); min-width: 70px;">MAY</th>
                                <th class="align-middle text-center" style="background: linear-gradient(180deg, #f8f9fa 0%, #e9ecef 100%); min-width: 70px;">JUN</th>
                                <th class="align-middle text-center" style="background: linear-gradient(180deg, #f8f9fa 0%, #e9ecef 100%); min-width: 70px;">JUL</th>
                                <th class="align-middle text-center" style="background: linear-gradient(180deg, #f8f9fa 0%, #e9ecef 100%); min-width: 70px;">AUG</th>
                                <th class="align-middle text-center" style="background: linear-gradient(180deg, #f8f9fa 0%, #e9ecef 100%); min-width: 70px;">SEP</th>
                                <th class="align-middle text-center" style="background: linear-gradient(180deg, #f8f9fa 0%, #e9ecef 100%); min-width: 70px;">OCT</th>
                                <th class="align-middle text-center" style="background: linear-gradient(180deg, #f8f9fa 0%, #e9ecef 100%); min-width: 70px;">NOV</th>
                                <th class="align-middle text-center" style="background: linear-gradient(180deg, #f8f9fa 0%, #e9ecef 100%); min-width: 70px;">DEC</th>

                                <!-- Summary columns -->
                                <th class="align-middle text-center" style="background-color: #e9ecef; min-width: 90px;">Total</th>
                                <th class="align-middle text-center" style="background-color: #e9ecef; min-width: 90px;">Total Month</th>
                                <th class="align-middle text-center" style="background-color: #e9ecef; min-width: 90px;">Monthly</th>
                                <th class="align-middle text-center" style="background-color: #e9ecef; min-width: 80px;">MSL</th>
                                <th class="align-middle text-center" style="background-color: #e9ecef; min-width: 80px;">S-MSL</th>
                            </tr>
                        </thead>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            function initializeDataTable() {
                $('#row-callback-datatable').DataTable({
                    serverSide: true,
                    ajax: {
                        url: '/movement-analysis-data-view',
                        type: 'GET',
                        beforeSend: function() {
