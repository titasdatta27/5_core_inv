@extends('layouts.vertical', ['title' => 'Ebay 3 - PINK DIL ADS', 'mode' => $mode ?? '', 'demo' => $demo ?? ''])
@section('css')
...
@section('content')
    @include('layouts.shared.page-title', [
        'page_title' => 'Ebay 3 - PINK DIL ADS',
        'sub_title' => 'Ebay 3 - PINK DIL ADS',
    ])
    <div class="row">
        <div class="col-12">
    ...
    <script>
        document.addEventListener("DOMContentLoaded", function() {
            ...
            var table = new Tabulator("#budget-under-table", {
                index: "Sku",
                ajaxURL: "/ebay-3/pink-dil/ads/data",
                layout: "fitData",
                movableColumns: true,
