@extends('layouts.vertical', ['title' => 'Form Advanced', 'mode' => $mode ?? '', 'demo' => $demo ?? ''])
                        ...
                        <div class="col-md-6">
                            <form action="#">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" placeholder="Enter date & time"
                        ...
                        <div class="col-md-6">
                            <form action="#">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" placeholder="Enter US telephone"
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" placeholder="Enter CPF"
                                        data-toggle="input-mask" data-mask-format="000.000.000-00" data-reverse="true">
                        ...
                        <div class="col-lg-6">
                            ...
                            <div class="mb-0">
                                ...
                                <input data-toggle="touchspin" value="77" type="text"
                                    data-bts-button-down-class="btn btn-danger" data-bts-button-up-class="btn btn-info">
                            </div>
                        </div> <!-- end col -->
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" placeholder="Max 25" maxlength="25"
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" placeholder="Max 25" maxlength="25"
                                    data-toggle="maxlength" data-threshold="12">
                            </div>
                        </div> <!-- end col -->
