@extends('layouts.vertical', ['title' => 'Amazon Organic Views', 'mode' => $mode ?? '', 'demo' => $demo ?? ''])
...
@section('content')
    @include('layouts.shared/page-title', ['page_title' => 'Amazon Organic Views Analysis', 'sub_title' => 'Amazon Organic Views'])
