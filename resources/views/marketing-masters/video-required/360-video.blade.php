@extends('layouts.vertical', ['title' => '360 Video Required'])
...
@section('content')
@include('layouts.shared.page-title', ['page_title' => '360 Video Required', 'sub_title' => '360 Video Required'])
...
<script>
    document.addEventListener('DOMContentLoaded', function () {
        ...
        const table = new Tabulator("#three60-video-req", {
            index: "Sku",
            ajaxURL: "/360-video-req/view-data",
            ajaxConfig: "GET",
            layout: "fitDataFill",
            pagination: true,
            paginationSize: 50,
        ...
        table.on("cellEdited", function(cell) {
            ...
            const payload = {
                ...
                value: {
                    ...
                    RefreshLink: rowData.RefreshLink,
                }
            };

            fetch("/360-video-req/save", {
                method: "POST",
                headers: {
        ...
        document.addEventListener("change", function (e) {
            ...
            const tableInstance = Tabulator.findTable("#three60-video-req")[0];
