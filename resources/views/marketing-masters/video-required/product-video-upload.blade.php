@extends('layouts.vertical', ['title' => 'Posted Video Upload'])
...
@section('content')
@include('layouts.shared.page-title', ['page_title' => 'Posted Video Upload', 'sub_title' => 'Posted Video Upload'])
...
<script>
    document.addEventListener("DOMContentLoaded", function() {
        ...
        const table = new Tabulator("#posted-video-req", {
            index: "Sku",
            ajaxURL: "/product-video-upload/view-data",
            ajaxConfig: "GET",
            layout: "fitDataFill",
            pagination: true,
            paginationSize: 50,
        ...
        table.on("cellEdited", function(cell) {
            ...
            fetch("/product-video-upload/save", {
                method: "POST",
                headers: {
