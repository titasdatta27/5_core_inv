@extends('layouts.vertical', ['title' => 'Assembly Video Required'])
...
@section('content')
@include('layouts.shared.page-title', ['page_title' => 'Assembly Video Required', 'sub_title' => 'Assembly Video Required'])
...
<script>
    document.addEventListener('DOMContentLoaded', function () {
        ...
        const table = new Tabulator("#assembly-video-req", {
            index: "Sku",
            ajaxURL: "/assembly-video-req/view-data",
            ajaxConfig: "GET",
            layout: "fitColumns",
            pagination: true,
            paginationSize: 50,
        ...
        document.addEventListener("change", function (e) {
            ...
            const tableInstance = Tabulator.findTable("#assembly-video-req")[0];
