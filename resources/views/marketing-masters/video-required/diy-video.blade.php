@extends('layouts.vertical', ['title' => 'DIY Video Required'])
...
@section('content')
@include('layouts.shared.page-title', ['page_title' => 'DIY Video Required', 'sub_title' => 'DIY Video Required'])
...
<script>
    document.addEventListener('DOMContentLoaded', function () {
        ...
        const table = new Tabulator("#diy-video-req", {
            index: "Sku",
            ajaxURL: "/diy-video-req/view-data",
            ajaxConfig: "GET",
            layout: "fitDataFill",
            pagination: true,
            paginationSize: 50,
            ...
            columns: [
                ...
                },
                {
                    ...
                    titleFormatter: function () {
                        return `<div>
                            Refresh <i class='fa fa-link'></i>
                        </div>`;
                    },
                    hozAlign: "center",
                },
                {
                    title: "Shoot Required",
                    field: "ShootRequired",
                    titleFormatter: function() {
                        return `<div>
                            Shoot Required<br>
                            <span id="total-shoot-header" style="font-size:13px;color:white;font-weight:600;"></span>
                        </div>`;
                    },
                    formatter: function (cell) {
                        const row = cell.getRow();
        ...
        table.on("cellEdited", function(cell) {
            ...
            const payload = {
                ...
                value: {
                    ...
                    ShootRequired: rowData.ShootRequired || false
                }
            };

            fetch("/diy-video-req/save", {
                method: "POST",
                headers: {
        ...
        function updateTotalInvAndL30(table) {
            ...
            const totalVideoLink = data.filter(row => row["AvlVideoLink"] && row["AvlVideoLink"].trim() !== "").length;
        ...
        document.addEventListener("change", function (e) {
            ...
            const tableInstance = Tabulator.findTable("#diy-video-req")[0];
