@extends('layouts.vertical', ['title' => 'Nine Ration Video'])
...
@section('content')
@include('layouts.shared.page-title', ['page_title' => 'Nine Ration Video', 'sub_title' => 'Nine Ration Video'])
...
<script>
    document.addEventListener('DOMContentLoaded', function () {
        ...
        const table = new Tabulator("#nine-ration-video", {
            index: "Sku",
            ajaxURL: "/nine-ration-video/view-data",
            ajaxConfig: "GET",
            layout: "fitColumns",
            pagination: true,
            paginationSize: 50,
