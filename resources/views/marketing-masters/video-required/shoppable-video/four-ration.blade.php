@extends('layouts.vertical', ['title' => 'Four Ration Video'])
...
@section('content')
@include('layouts.shared.page-title', ['page_title' => 'Four Ration Video', 'sub_title' => 'Four Ration Video'])
...
<script>
    document.addEventListener('DOMContentLoaded', function () {
        ...
        const table = new Tabulator("#four-ration-video", {
            index: "Sku",
            ajaxURL: "/four-ration-video/view-data",
            ajaxConfig: "GET",
            layout: "fitColumns",
            pagination: true,
            paginationSize: 50,
