@extends('layouts.vertical', ['title' => 'DIY Video Upload'])
...
@section('content')
@include('layouts.shared.page-title', ['page_title' => 'DIY Video Upload', 'sub_title' => 'DIY Video Upload'])
...
<script>
    document.addEventListener("DOMContentLoaded", function() {
        ...
        const table = new Tabulator("#posted-video-req", {
            index: "Sku",
            ajaxURL: "/diy-video-upload/view-data",
            ajaxConfig: "GET",
            layout: "fitDataFill",
            pagination: true,
            paginationSize: 50,
