@extends('layouts.vertical', ['title' => 'Carousel Sales', 'mode' => $mode ?? '', 'demo' => $demo ?? ''])
...
@section('content')
    @include('layouts.shared/page-title', ['page_title' => 'Carousel Sales', 'sub_title' => 'Marketing Master'])
    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    <!-- <h4 class="header-title">Carousel Sales</h4> -->
                    ...
                    <div id="data-loader" class="card-loader-overlay" style="display: none;">
                        <div class="loader-content">
                            ...
                            <div class="loader-text">Loading Carousel Sales data...</div>
                        </div>
                    </div>
                </div>
            </div>
