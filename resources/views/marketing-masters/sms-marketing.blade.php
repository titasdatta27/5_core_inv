@extends('layouts.vertical', ['title' => 'SMS Marketing', 'mode' => $mode ?? '', 'demo' => $demo ?? ''])
...
@section('content')
    @include('layouts.shared/page-title', ['page_title' => 'SMS Marketing', 'sub_title' => 'Marketing Master'])
                ...
                <div class="card-body">
                    ...
                    <div id="data-loader" class="card-loader-overlay" style="display: none;">
                        <div class="loader-content">
                            ...
                            <div class="loader-text">Loading SMS Marketing data...</div>
                        </div>
                    </div>
                </div>
            </div>
