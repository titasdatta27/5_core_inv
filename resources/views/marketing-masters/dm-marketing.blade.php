@extends('layouts.vertical', ['title' => 'DM Marketing', 'mode' => $mode ?? '', 'demo' => $demo ?? ''])
...
@section('content')
    @include('layouts.shared/page-title', ['page_title' => 'DM Marketing', 'sub_title' => 'Marketing Master'])
                ...
                <div class="card-body">
                    ...
                    <div id="data-loader" class="card-loader-overlay" style="display: none;">
                        <div class="loader-content">
                            ...
                            <div class="loader-text">Loading DM Marketing data...</div>
                        </div>
                    </div>
                </div>
            </div>
