@extends('layouts.vertical', ['title' => 'Tik Tok Video Ads'])
...
@section('content')
@include('layouts.shared.page-title', ['page_title' => 'Tik Tok Video Ads', 'sub_title' => 'Tik Tok Video Ads'])
...
<script>
    document.addEventListener('DOMContentLoaded', function () {
        ...
        const table = new Tabulator("#tiktok-video-ads", {
            index: "Sku",
            ajaxURL: "/tikotok-video-ads",
            ajaxConfig: "GET",
            layout: "fitColumns",
            pagination: true,
            paginationSize: 50,
        ...
        document.addEventListener("change", function (e) {
            ...
            const tableInstance = Tabulator.findTable("#tiktok-video-ads")[0];
