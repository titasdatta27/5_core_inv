@extends('layouts.vertical', ['title' => 'Facebook In Feed Ads'])
...
@section('content')
@include('layouts.shared.page-title', ['page_title' => 'Facebook In Feed Ads', 'sub_title' => 'Facebook In Feed Ads'])
...
<script>
    document.addEventListener('DOMContentLoaded', function () {
        ...
        const table = new Tabulator("#facebook-feed-ads", {
            index: "Sku",
            ajaxURL: "/facebook-feed-ads",
            ajaxConfig: "GET",
            layout: "fitColumns",
            pagination: true,
            paginationSize: 50,
        ...
        document.addEventListener("change", function (e) {
            ...
            const tableInstance = Tabulator.findTable("#facebook-feed-ads")[0];
