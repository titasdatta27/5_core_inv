@extends('layouts.vertical', ['title' => 'Youtube Shorts Ads'])
...
@section('content')
@include('layouts.shared.page-title', ['page_title' => 'Youtube Shorts Ads', 'sub_title' => 'Youtube Shorts Ads'])
...
<script>
    document.addEventListener('DOMContentLoaded', function () {
        ...
        const table = new Tabulator("#youtube-shorts-ads", {
            index: "Sku",
            ajaxURL: "/youtube-shorts-ads",
            ajaxConfig: "GET",
            layout: "fitColumns",
            pagination: true,
            paginationSize: 50,
        ...
        document.addEventListener("change", function (e) {
            ...
            const tableInstance = Tabulator.findTable("#youtube-shorts-ads")[0];
