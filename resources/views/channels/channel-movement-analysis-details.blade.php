@extends('layouts.vertical', ['title' => 'Sales & Analysis Details', 'mode' => $mode ?? '', 'demo' => $demo ?? ''])
...
@section('content')
    @include('layouts.shared/page-title', [
        'page_title' => 'Sales & Analysis Details',
    ...
    <div class="container-fluid">
        ...
        <div class="col-md-12 mt-0 pt-0 mb-1 pb-1">
            <div class="d-flex justify-content-between align-items-center gap-2 flex-wrap">
                ...
                <div class="d-flex justify-content-between align-items-center mb-2">
                    <h5 class="fw-bold">{{ $channel }} - Monthly Breakdown</h5>
                    <a href="/channels" class="btn btn-sm btn-secondary">
        ...
        <div class="table-container"  id="channelTableWrapper" style="display: none;">
            <div class="table-responsive" style="max-height: 500px; overflow: auto;">
                <table class="table table-hover table-striped mb-0" id="monthlyAnalysisTable">
...
@section('script')
    ...
    <script>
        ...
        function initializeDataTable() {
            try {
                const table = $('#monthlyAnalysisTable').DataTable({
                    paging: false,
                    searching: false,
                    ordering: false,
                    responsive: true,
        ...
        jq(document).ready(function () {
            ...
            function fetchMonthlyData() {
                let channel = "{{ $channel }}";
                $.ajax({
                    url: `/channels/get-monthly-data/${channel}`,
                    type: "GET",
                    success: function (res) {
                        $('#monthlyTableBody').html(res.html);
                    },
                    error: function () {
            ...
            $(document).on('blur', '.editable', function () {
                ...
                $.ajax({
                    ...
                    success: function (res) {
                        if (res.expense_percentage !== undefined) {
                            // update that cell
                            $(`td[data-month="${month}"][data-field="receipt_amount"]`).closest('tr').find('td:nth-child(5)').text(res.expense_percentage + "%");
                        }
                    }
                });
            });
        ...
        //         $.ajax({
        //             url: '/channel-movement/update-field',
        //             type: 'POST',
        //             data: {
        //                 _token: '{{ csrf_token() }}',
        //                 field,
        ...
        //             success: function (res) {
        //                 if (res.expense_percentage !== undefined) {
        //                     location.reload(); // Reload to reflect % expense update
        //                 }
        //             },
        //             error: function (xhr) {
